...
#update fields 
gps6$study <- "Aspafallet"
gps6$Study_Year <- paste("Aspafallet", format(gps6$Date_time,"%Y"), sep="_")
...
colnames(date.summary) <- c("Territory_year", "Start", "End","Range","Nblocations", "Territory", "Season","Start", "End" )
